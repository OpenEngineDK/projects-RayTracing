...
\fixme{refere til appendix med kodebeskrivelse et sted.}
...
decade, as evidenced by \reffig{fig:gflops}. Unfortunatly, even with
...
\reffig{fig:binarySplit}. In order to facilitate dynamic scenes, the
...
\fixme{Uddybe optimeringsmetoderne og måske referer til de sektioner
  hvor de vil opstå. Beskrive sammenhængen mellem 2 og 3 og at det er
  den der er fokus!}
