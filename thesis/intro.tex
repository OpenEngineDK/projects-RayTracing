...
\begin{figure}
  ...
  \vspace{3mm}
  \parbox{7cm}{\caption{An example of cube mapping. The environment is
      rendered onto the sides of the cube and then mapped onto the
      sphere. The mapping is performed by using the calculated
      reflection vector as a texture coordinate.}\label{fig:cubemap}}
