...
\textit{binary space partition} tree that recursively subdivides
$k$-dimensional geometry by splitting it with axis aligned splitting
planes. One such subdivision can be seen on
