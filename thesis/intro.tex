...
% During this I will look at the usefulness of data structures on the
% GPU, given that a binairy data structure is not easy for the GPU to
% handle and breaks coalescence. A brute force raytracer, that
% performs intersection with all triangles, will be used to test
% wether or not data structures on the GPU even makes sense.
