...
the kernels. Threads can then use fast block local memory to cooperate
and share data. Threads can lookup their \textit{thread index} inside
a block through the 3 dimensional \textit{threadIdx} CUDA built-in
