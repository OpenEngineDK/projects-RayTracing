...
threads in a block are now live, compared with every $offset$'th thread in the
...
small. Thirdly we can take advantage of warp synchronization and remove explicit
synchronization invocations when offset becomes less than the warp size.
