...
of the thesis uses the \textit{generel lighting equation} described on page 83
...
cost of traversing the tree. Unfortunatly tracing several rays in one thread
...
clearly see that it will intersect leaf node 2. Unfortunatly, when using
...
generel solution to diverging rays will be presented under Future Work in
