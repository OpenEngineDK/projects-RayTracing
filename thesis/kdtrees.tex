...
restructured to work on multiple nodes at a time. Fortunatly this is
exactly what \zhou did by changing the kd-tree constructor to work on
a list of nodes and recursively create the tree in
...
% axis. To do this a preprocess pass is required to compute tight
% AABB's for each triangle.
