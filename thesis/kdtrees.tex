...
exploit the graphics hardware, as only a couple of nodes are created
per pass. But at lower levels, where thousands of nodes are created at
a time, breadth-first creation allows full utilization of the
hardware.
