...
% bounding box inside the modified bouding box. Then approximate the
...
% Dvide triangles eg. adjust bounding box instead of splitting the
% triangles.
...
\item
Opret child nodes og sortere dem efter leaf/nonLeaf.
