...
smaller tree nodes. \refalg{alg:kdTreeCreator} describes a general
...
%      \draw[ball color=gray, color=green, shading=ball,gray] (0,0) -- (0,6) -- (6,6) -- (6,0) -- (0,0);
  ...
  \caption[Empty Space Maximization.]{An example of Empty Space Maximizing. The
    ...
    thus skipping intersection tests with the 5 triangles
...
triangles. This last case however is highly unlikely and in general it can be
