...
the basic idea of ray casting, using it to solve the \textit{hidden surface
...
In his PHD-thesis\citebook{Havran:PhD} from 2000, Havran argued that the kd-tree
